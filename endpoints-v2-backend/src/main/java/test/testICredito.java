...
public class testICredito {
	...
	public void testTarjetaPago1() {
		setupEscenario1();
		assertEquals("La fecha del sistema debe coincidir con la ingresada.", "1234567898745632",
				pagoC.getNumTarjeta());
	}
	...
	public void testTarjetaPago2() {
		setupEscenario2();
		assertEquals("La fecha del sistema debe coincidir con la ingresada.", "9876543212365478",
				pagoC.getNumTarjeta());
	}
	...
	public void testTarjetaPago3() {
		setupEscenario3();
		assertEquals("La fecha del sistema debe coincidir con la ingresada.", "6547539512584560",
				pagoC.getNumTarjeta());
	}
	...
	public void testSeguCodPago1() {
		setupEscenario1();
		assertEquals("La fecha del sistema debe coincidir con la ingresada.", "753", pagoC.getSegucode());
	}

	@Test
	public void testSeguCodPago2() {
		setupEscenario2();
		assertEquals("La fecha del sistema debe coincidir con la ingresada.", "681", pagoC.getSegucode());
	}

	@Test
	public void testSeguCodPago3() {
		setupEscenario3();
		assertEquals("La fecha del sistema debe coincidir con la ingresada.", "431", pagoC.getSegucode());
	}

	@Test
	public void testCuotasPago1() {
		setupEscenario1();
		assertEquals("La fecha del sistema debe coincidir con la ingresada.", "6", pagoC.getCuotas());
	}

	@Test
	public void testCuotasPago2() {
		setupEscenario2();
		assertEquals("La fecha del sistema debe coincidir con la ingresada.", "12", pagoC.getCuotas());
	}

	@Test
	public void testCuotasPago3() {
		setupEscenario3();
		assertEquals("La fecha del sistema debe coincidir con la ingresada.", "1", pagoC.getCuotas());
	}
